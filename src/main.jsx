...
function GearView({gear,refreshAll,setMessage}){
 ...
 const filtered=gear.filter(g=>`${g.name} ${g.category} ${g.location} ${g.brand}`.toLowerCase().includes(q.toLowerCase())&&(!categoryFilter||g.category===categoryFilter)&&(!locationFilter||g.location===locationFilter))
