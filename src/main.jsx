...
function ListsView({gear,lists,listItems,refreshAll,setMessage}){
 const [name,setName]=useState('');const [desc,setDesc]=useState('');const [q,setQ]=useState('')
